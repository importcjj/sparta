  ...
  */
          ...
          if (!rescaleY) {
            var seriesDomains = data
              ...
              .map(function(series, i) {
                ...
                return [
                  (initialDomain[0] - initialDomain[1]) / (1 + initialDomain[1]), (initialDomain[1] - initialDomain[0]) / (1 + initialDomain[0])
                ];
              });
  ...
  nv.models.discreteBar = function() {
    ...
    var margin = {
      ...
      xDomain, yDomain, xRange, yRange, dispatch = d3.dispatch('chartClick', 'elementClick', 'elementDblClick', 'elementMouseover', 'elementMouseout'),
  ...
  nv.models.multiBar = function() {
    ...
    var margin = {
      ...
      , delay = 1200,
      xDomain, yDomain, xRange, yRange, groupSpacing = 0.1,
